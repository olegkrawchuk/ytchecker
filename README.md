...
- Інструмент не вирішує переривання під час лайву в реальному часі (немає API донат-платформи, щоб перевіряти автоматично) — це свідоме обмеження, деталі й розглянуті альтернативи в [`product_research_notes.md`](product_research_notes.md).
